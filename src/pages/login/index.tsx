...
export default function Login() {
	return (
		<main className="w-full relative flex flex-col">
			...
			<header className="w-full px-20 bg-gradient-to-b from-black z-10">
				<img
			...
			<footer className="w-full h-60 bg-neutral-900"></footer>
		</main>
	);
}
...
function LoginForm() {
	...
	return (
		<form
			...
			<Button
				type="submit"
				className="rounded-md w-full bg-red-600 hover:bg-red-600 h-12">
				{isSignUpForm ? 'Sign Up' : 'Sign In'}
			</Button>
